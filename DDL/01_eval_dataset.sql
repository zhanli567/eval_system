...
COMMENT ON COLUMN t_eval_dataset.created_at IS '创建时间';
COMMENT ON COLUMN t_eval_dataset.updated_at IS '更新时间';
...
COMMENT ON COLUMN t_eval_dataset_version.created_at IS '创建时间';
COMMENT ON COLUMN t_eval_dataset_version.updated_at IS '更新时间';
...
COMMENT ON COLUMN t_eval_dataset_field.created_at IS '创建时间';
COMMENT ON COLUMN t_eval_dataset_field.updated_at IS '更新时间';
...
COMMENT ON COLUMN t_eval_dataset_item.created_at IS '创建时间';
COMMENT ON COLUMN t_eval_dataset_item.updated_at IS '更新时间';
...
COMMENT ON COLUMN t_eval_dataset_item_cell.created_at IS '创建时间';
COMMENT ON COLUMN t_eval_dataset_item_cell.updated_at IS '更新时间';
