...
<template>
  ...
  <el-dialog v-model="dialogVisible" :title="dialogTitle" class="tag-dialog fixed-dialog" style="--fixed-dialog-width: min(900px, 86vw); --fixed-dialog-height: min(660px, 86vh)" :close-on-click-modal="true">
  ...
  <el-dialog v-model="detailDialogVisible" title="标签详情" class="tag-dialog tag-detail-dialog fixed-dialog" style="--fixed-dialog-width: min(760px, 86vw); --fixed-dialog-height: min(560px, 82vh)" :close-on-click-modal="true">
