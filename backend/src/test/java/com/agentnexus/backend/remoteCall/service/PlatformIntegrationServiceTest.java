...
class PlatformIntegrationServiceTest {
  ...
  private class FakeMasterServiceClient implements MasterServiceClient {
    @Override
    public PlatformRemoteResponse<PlatformListResult<PlatformModelInfo>> listModels(int pageSize, int curPage, String spaceId) {
      return get("/models/" + pageSize + "/" + curPage, spaceId, new TypeReference<>() {
      });
    }

    @Override
    public PlatformRemoteResponse<PlatformListResult<PlatformSuperAgentInfo>> listAgents(int pageSize, int curPage, String spaceId) {
      return get("/super-agents/" + pageSize + "/" + curPage, spaceId, new TypeReference<>() {
      });
    }

    @Override
    public PlatformRemoteResponse<PlatformSuperAgentDetail> getAgentDetail(String superAgentId, String spaceId) {
